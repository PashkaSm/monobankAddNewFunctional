    ...
    <div className="header-wrapper">
      <div className="header-main-layout">
        <div className="header-logo-container">
          {/* компонента роутинга яка допомогає переходити по сторінках 
          При атиску на даний блок нас буде перекидати на головну сторінку
          */}
        ...
        <div className="header-settings">
          <ul className="header-settings-list">
            {/* перехід на сторінку /moneytransfer і забирається стрілочка 
            і сайд барі за допомогою класу актів нижче зроблено аналогічно 
            */}
            <NavLink
              to="/moneytransfer"
              className={({ isActive }) =>
